...
class PlantStatusHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        return (
            ...
            .speak(f"Hello! Moisture reading is 35")
            .speak(f"Hello! Temperature is 35 Celsius")
            .response
        )
...
skill_builder.add_request_handler(PlantStatusHandler())
